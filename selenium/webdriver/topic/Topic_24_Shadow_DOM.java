...
public class Topic_24_Shadow_DOM {
    ...
    @Test
    public void TC_01_ShadowDOM_Automationfc(){
    ...
    @Test
    public void TC_02_Shadow_Books() throws InterruptedException {
...
//        System.out.println(mainContentShadowTitles.size());
    ...
    @Test
    public void TC_03_Shadow_Shoppe() throws InterruptedException {
        driver.get("https://shopee.vn/");
        WebElement shadowHost = driver.findElement(By.cssSelector("shopee-banner-popup-stateful"));
        SearchContext shadowRoot = shadowHost.getShadowRoot();
        WebElement popupCloseBtn = shadowRoot.findElement(By.cssSelector("div#shopee-popup__close-btn"));
        popupCloseBtn.click();
        Thread.sleep(2000);

        WebElement popup = shadowRoot.findElement(By.cssSelector("div#home-popup__content"));
