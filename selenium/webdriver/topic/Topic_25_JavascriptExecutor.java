...
//        driver = new FirefoxDriver();
    ...
    @Test
    public void TC_01_LearnJS() throws InterruptedException {
        driver.get("https://demo.nopcommerce.com/login");
        // Get title
        System.out.println("Selenium Title: " + driver.getTitle());
        System.out.println("JS Title: " + jsExecutor.executeScript("return document.title;"));

        // Get URL/ Domain
        System.out.println("Selenium URL: " + driver.getCurrentUrl());
        System.out.println("JS URL: " + jsExecutor.executeScript("return document.URL;"));
        System.out.println("JS Domain: " + jsExecutor.executeScript("return document.domain;"));

        // Select element by JS Script
        WebElement emailEle = (WebElement) jsExecutor.executeScript(" return document.getElementById('Email');");
        emailEle.sendKeys("aaaa");
        Thread.sleep(2000);
        WebElement loginBtnEle = (WebElement) jsExecutor.executeScript("return document.getElementsByClassName('login-button')[0];");
        loginBtnEle.click();
        Thread.sleep(3000);
        WebElement emailErrorEle = (WebElement) jsExecutor.executeScript("return document.getElementById('Email-error');");
        String error = (String) jsExecutor.executeScript("return arguments[0].innerText;", emailErrorEle);
        ...
        // Open any URL with JS
        jsExecutor.executeScript("window.location='https://automationfc.github.io/';");
        Thread.sleep(2000);
    ...
    @Test
    public void TC_02_JavaScript_Techpanda() throws InterruptedException {
        // Navigate to URL
    ...
    @Test
    public void TC_03_JavaScript_Techpanda_Using_Functions() {
        // Navigate to URL
    ...
    @Test
    public void TC_04_HTML5_JS_Automationfc(){
        ...
        submitBtnEle.click();
        if(driver.toString().contains("Chrome")){
            Assert.assertEquals(validateEmail,"Please enter a part following '@'. '123@' is incomplete.");
        } else {
            Assert.assertEquals(validateEmail,"Please enter an email address.");
        }
    ...
    @Test
    public void TC_05_HTML5_JS_Many_Pages(){
    ...
    @Test
    public void TC_06_JavaScript_Create_An_Account() throws InterruptedException {
